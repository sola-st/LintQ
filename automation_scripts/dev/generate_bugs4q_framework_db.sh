...
# folder (e.g. data/datasets/Bugs4Q-Framework_08_08_2023/Bugs4Q_raw) and moves them in
# a folder (e.g. data/datasets/Bugs4Q-Framework_08_08_2023/raw_files).

# Then it creates a test database in the folder:
# data/datasets/Bugs4Q-Framework_08_08_2023/codeql_db

# move to the directory of this file
cd "$(dirname "$0")"

dataset_path=../data/datasets/Bugs4Q-Framework_08_08_2023
...
folder_to_mine=../data/datasets/Bugs4Q-Framework_08_08_2023/Bugs4Q-Framework_cloned_from_git

# scan all the python files in the folder which contain
# the string "buggy" in their name
for file in $(find $folder_to_mine -name "*buggy*.py") ; do
    ...
    github_link=https://github.com/Z-928/Bugs4Q-Framework/blob/master/$last_two_folders
